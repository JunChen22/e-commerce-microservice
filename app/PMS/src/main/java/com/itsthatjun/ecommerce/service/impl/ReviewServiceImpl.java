...
import com.itsthatjun.ecommerce.model.entity.ReviewUpdateLog;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public Mono<ReviewDTO> createReview(Review newReview, List<ReviewAlbumPicture> picturesList, int userId) {
        return null;
    }

    @Override
    public Mono<ReviewDTO> updateReview(Review updatedReview, List<ReviewAlbumPicture> picturesList, int userId) {
        return null;
    }
