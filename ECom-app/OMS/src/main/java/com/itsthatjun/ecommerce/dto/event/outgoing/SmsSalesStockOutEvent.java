...
@Getter
public class SmsSalesStockOutEvent {
    ...
    // update sales stock
    public SmsSalesStockOutEvent(Type eventType, String orderSN, Map<String, Integer> productMap) {
