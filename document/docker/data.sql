...
CREATE TABLE permission (
    id SERIAL PRIMARY KEY,
    parent_id INTEGER NOT NULL,-- sub permission
    name TEXT,
    permission_key TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    status INTEGER DEFAULT 0
...
('adminacct', '$2a$10$c.FVHJ7x9Gedv.StYqdOB.FB1dNVCLBxS76ZbLutbTHwL15hcFGh2', 'admin@gmail.com', 'jun', '2020-03-18 22:18:40', 1),
('adminacctorder', '$2a$10$c.FVHJ7x9Gedv.StYqdOB.FB1dNVCLBxS76ZbLutbTHwL15hcFGh2', 'order@gmail.com', 'jun', '2020-03-18 22:18:40', 1),
('adminacctuser', '$2a$10$c.FVHJ7x9Gedv.StYqdOB.FB1dNVCLBxS76ZbLutbTHwL15hcFGh2', 'user@gmail.com', 'jun', '2020-03-18 22:18:40', 1),
('devacct', '$2a$10$zykJppm18avEb79CGEtFjOIwKlgUJ4BeMFiF8HGjccVMgJ8XTjZpy', 'dev@gmail.com', 'dev', '2020-03-20 12:06:40', 1);


INSERT INTO roles (name, description, created_at, status)
VALUES
('ROLE_admin-product', 'manage product issues', '2020-03-23 09:42:22', 1),
('ROLE_admin-order', 'manage order issues', '2020-03-23 09:42:22', 1),
('ROLE_admin-user', 'manage user related issue', '2020-03-21 12:35:20', 1),
('ROLE_admin-sale', 'manage sale issues', '2020-03-23 09:42:22', 1),
('ROLE_admin-content', 'manage content issues', '2020-03-23 09:42:22', 1),
('ROLE_admin-root', 'root', '2020-03-18 22:18:40', 1),
('ROLE_member', 'root', '2020-03-18 22:18:40', 1);


INSERT INTO permission (parent_id, name, permission_key, created_at, status)
VALUES
-- base permission
('0', 'product', null, '2019-08-18 16:00:38', 1),
('0', 'order', null, '2019-08-18 16:00:38', 1),
('0', 'user', null, '2019-08-18 16:00:38', 1),
('0', 'sales', null, '2019-08-18 16:00:38', 1),
('0', 'content', null, '2019-08-18 16:00:38', 1),

-- CRUD product
('1', 'create product', 'product_create', '2019-08-18 16:00:38', 1),
('1', 'read product', 'product_read', '2019-08-18 16:00:38', 1),
('1', 'update product', 'product_update', '2019-08-18 16:00:38', 1),
('1', 'delete product', 'product_delete', '2019-08-18 16:00:38', 1),

('1', 'create brand', 'brand_create', '2019-08-18 16:00:38', 1),
('1', 'read brand', 'brand_read', '2019-08-18 16:00:38', 1),
('1', 'update brand', 'brand_update', '2019-08-18 16:00:38', 1),
('1', 'delete brand', 'brand_delete', '2019-08-18 16:00:38', 1),

('1', 'create product_category', 'product_category_create', '2019-08-18 16:00:38', 1),
('1', 'read product_category', 'product_category_read', '2019-08-18 16:00:38', 1),
('1', 'update product_category', 'product_category_update', '2019-08-18 16:00:38', 1),
('1', 'delete product_category', 'product_category_delete', '2019-08-18 16:00:38', 1),

('1', 'create product_attribute', 'product_attribute_create', '2019-08-18 16:00:38', 1),
('1', 'read product_attribute', 'product_attribute_read', '2019-08-18 16:00:38', 1),
('1', 'update product_attribute', 'product_attribute_update', '2019-08-18 16:00:38', 1),
('1', 'delete product_attribute', 'product_attribute_delete', '2019-08-18 16:00:38', 1),

-- CRUD Order
('2', 'create order', 'order_create', '2019-08-18 16:00:38', 1),
('2', 'read order', 'order_read', '2019-08-18 16:00:38', 1),
('2', 'update order', 'order_update', '2019-08-18 16:00:38', 1),
('2', 'delete order', 'order_delete', '2019-08-18 16:00:38', 1),

-- CRUD user
('3', 'create user', 'user_create', '2019-08-18 16:00:38', 1),
('3', 'read user', 'user_read', '2019-08-18 16:00:38', 1),
('3', 'update user', 'user_update', '2019-08-18 16:00:38', 1),
('3', 'delete user', 'user_delete', '2019-08-18 16:00:38', 1),

-- CRUD Sales
('4', 'create sales', 'sales_create', '2019-08-18 16:00:38', 1),
('4', 'read sales', 'sales_read', '2019-08-18 16:00:38', 1),
('4', 'update sales', 'sales_update', '2019-08-18 16:00:38', 1),
('4', 'delete sales', 'sales_delete', '2019-08-18 16:00:38', 1),

-- CRUD Content
('5', 'create content', 'content_create', '2019-08-18 16:00:38', 1),
('5', 'read content', 'content_read', '2019-08-18 16:00:38', 1),
('5', 'update content', 'content_update', '2019-08-18 16:00:38', 1),
('5', 'delete content', 'content_delete', '2019-08-18 16:00:38', 1);
...
insert into admin_login_log (admin_id, login_time, ip_address, user_agent)
VALUES
(2, '2022-06-22 9:37:00', '134.163.118.46', 2),
(1, '2023-02-10 16:29:00', '63.34.62.42', 2),
(1, '2023-03-24 19:37:00', '135.233.10.69', 1),
(1, '2022-09-12 1:38:00', '20.247.202.109', 2),
(2, '2023-02-15 20:00:00', '36.98.223.124', 2),
(3, '2022-06-23 6:28:00', '173.205.10.223', 1),
(3, '2023-04-22 11:15:00', '196.204.187.66', 1),
(3, '2022-05-04 12:59:00', '71.116.127.75', 1),
(3, '2023-04-29 10:24:00', '150.162.71.34', 1),
(2, '2022-07-17 23:12:00', '120.114.34.124', 1),
(2, '2022-06-09 2:29:00', '217.211.41.124', 1),
(2, '2022-09-06 17:55:00', '123.88.59.30', 2),
(1, '2022-11-16 15:38:00', '38.151.187.192', 1),
(2, '2023-03-14 19:25:00', '240.177.24.96', 1),
(1, '2022-10-22 9:27:00', '21.229.17.241', 2),
(2, '2022-10-01 14:26:00', '10.201.14.67', 2),
(2, '2022-06-23 0:04:00', '60.94.22.72', 1),
(1, '2022-12-21 7:41:00', '31.173.45.239', 1),
(1, '2022-08-25 1:44:00', '93.236.87.97', 2),
(1, '2023-03-21 19:46:00', '188.250.113.175', 2),
(2, '2023-02-26 13:03:00', '218.254.5.254', 1),
(2, '2022-11-23 18:33:00', '104.148.201.62', 2),
(1, '2022-12-02 9:31:00', '78.116.167.232', 1),
(3, '2022-11-22 6:26:00', '235.188.63.46', 1),
(1, '2022-06-27 18:32:00', '94.211.177.207', 2),
(2, '2022-07-24 23:45:00', '165.173.17.183', 2),
(2, '2023-02-03 9:38:00', '124.116.179.206', 1),
(1, '2022-12-23 23:22:00', '128.42.207.29', 1),
(3, '2022-10-22 20:38:00', '68.210.228.208', 2),
(2, '2022-05-29 21:51:00', '165.130.166.222', 1);
