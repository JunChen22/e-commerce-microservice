package jun.chen.springcloud.authorizationserver.config;

import com.nimbusds.jose.jwk.JWKSet;
import com.nimbusds.jose.jwk.RSAKey;
import com.nimbusds.jose.jwk.source.JWKSource;
import com.nimbusds.jose.proc.SecurityContext;
import jun.chen.springcloud.authorizationserver.jose.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient writerClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .authorizationGrantType(AuthorizationGrantType.PASSWORD) // added to test
                .authorizationGrantType(AuthorizationGrantType.IMPLICIT) // added to test
